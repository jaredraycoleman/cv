...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
      {NetCompute 2026 --- 1st Workshop on Computation over Heterogeneous Networks @ INFOCOM}{}
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
      {NSF \#2542375 --- Conference: Building Scientific and Collaborative Capacity for AI in Indigenous Language Research}{\$50,000}
      {Principal Investigator}{2025}

    \resumeSubheading
      {NSF \#2451267 --- CRII: CSR: RUI: Novel Approaches for Task Graph Scheduling Algorithm Design, Evaluation, and Comparison}{\$150,000}
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
      {IPDPS 2026 --- 40th International Parallel and Distributed Processing Symposium}{}
      {Tutorial: ``Resilient Scheduling in Distributed Systems: Benchmarking and Adversarial Analysis with SAGA''}{May 25, 2026}

    \resumeSubheading
      {ICDCN 2026 --- 27th International Conference on Distributed Computing and Networking}{}
      {Tutorial: ``Resilient Scheduling in Distributed Systems: Benchmarking and Adversarial Analysis with SAGA''}{January 9, 2026}
