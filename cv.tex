...
\newcommand{\pubListStart}{\begin{enumerate}[leftmargin=*,label={[\arabic*]}]}
\newcommand{\pubListEnd}{\end{enumerate}}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Member of the Technical Staff}{Mar 2020 -- Present}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \item[-]{Organized computer skills workshops for high school students in tribal work-experience program}
...
\resumeSubHeadingListStart
    ...
    \resumeSubheadingTwo
      {First-Place Winner}{}
      {2nd Student Design Competition on Networked Computing on the Edge @ CPS IoT Week}{2022}
