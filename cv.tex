...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
    {University of Southern California}{Los Angeles, CA}
    {Adjunct Research Assistant Professor of Electrical and Computer Engineering}{July 2024 -- Present}

    \resumeSubheading
    {Coinbase}{Remote}
    {Consultant - Machine Learning Engineer}{Jan 2025 -- Present}

    \resumeSubheading
    {Loyola Marymount University}{Los Angeles, CA}
    {Assistant Professor of Computer Science}{Aug 2024 -- Present}
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Professor}{Fall 2024, Spring 2025, Fall 2025}
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
      {NetCompute: Computation over Heterogeneous Networks @ INFOCOM 2026}{}
      {Workshop Chair / Organizer}{May, 2026}

    \resumeSubheading
      {Indigenous Working Group @ LMU}{}
      {Chair (elected October 2025); Member since 2024}{2024--present}

    \resumeSubheading
      {Workshop on AI and Indigenous Languages}{}
      {Organizing Committee Chair}{September, 2025--present}

    \resumeSubheading
      {Seaver College DEI Committee}{}
      {Member}{2025--present}

    \resumeSubheading
      {LMU GenAI Task Force}{}
      {Member}{August, 2025--present}

    \resumeSubheading
      {CS GenAI Task Force @ LMU}{}
      {Member}{July, 2025--present}

    \resumeSubheading
      {Theoretical Computer Science Journal}{}
      {Reviewer}{December, 2025}
    ...
    \resumeSubheading
      {AAAI 2026 --- Special Track on AI for Social Impact}{}
      {Program Committee Member}{September, 2025}

    \resumeSubheading
      {WISDOM 2025 Workshop}{San Diego, CA}
      {Program Committee Member}{July, 2025}
    ...
    \resumeSubheading
      ...
      {DLI-DEL Advisory Panel Member}{Spring 2025}
...
%-----------MENTORSHIP-----------------
\section{Mentorship / Research Advising}
\resumeSubHeadingListStart
    \resumeSubheading
      {Matias Martinez Gonzalez and Nicholas Laus (Undergrad)}{}
      {Task Graph Scheduling --- SAGA Integrations}{2025 - present}

    \resumeSubheading
      {Harsh Devisha (Masters)}{}
      {Cooperative Mobile Agents}{2025 - present}

    \resumeSubheading
      {Quinn Austin and Sebastian Lange (Undergrad)}{}
      {Kubishi Scholar}{2025 - present}

    \resumeSubheading
      {Diego Cuadros and Nicholas Leeds (Undergrad)}{}
      {Retreival Augmented Generation for LLM-powered Low-Resource Machine Translation}{2024 - present}

    \resumeSubheading
      {Kathan Pathak (Masters)}{}
      {Culturally Appropriate Image Generation for Language Education}{2024 - 2025}

    \resumeSubheading
      {Gabriel Twigg-Ho and Jason Chamorro (Undergrad)}{}
      {Stochastic Task Graph Scheduling}{2024 - present}

    \resumeSubheading
      {Rohin Gupta (High School)}{}
      {Using Simulated Annealing for Task Graph Scheduling}{2024}
...
\resumeSubHeadingListStart
    ...
    \resumeSubheadingTwo
      {NSF \#2542375 (PI)}{\$50,000}
      {Conference: Building Scientific Capacity for AI in Indigenous Language Research}{2025}
      {}{}

    \resumeSubheadingTwo
      {NSF \#2451267 (PI)}{\$150,000}
      {CRII: CSR: RUI: Novel Approaches for Task Graph Scheduling Algorithm Design,}{2025--2027}
...
%-----------INVITED TALKS-----------------
\section{Invited Talks \& Tutorials}
\resumeSubHeadingListStart

    \resumeSubheading
      {IPDPS 2026 --- Int'l Parallel and Distributed Processing Symposium}{}
      {Tutorial: ``Resilient Scheduling: Benchmarking and Adversarial Analysis with SAGA''}{May 25, 2026}

    \resumeSubheading
      {ICDCN 2026 --- Int'l Conf. on Distributed Computing and Networking}{}
      {Tutorial: ``Resilient Scheduling: Benchmarking and Adversarial Analysis with SAGA''}{January 9, 2026}

    \resumeSubheading
      {Lectures on Linguistics and Language Series, University of Illinois Chicago}{Chicago, IL}
      {Invited Speaker --- LLMs and Endangered Language Revitalization}{November 12, 2025}

    \resumeSubheading
      {Workshop on IoT for Adversarial Environments @ MILCOM 2025}{Los Angeles, CA}
      {Invited Visionary Talk: ``Rethinking Scheduling for Resilience in Mission-Critical IoT Workflows''}{October 6, 2025}

    \resumeSubheading
      {Institute of Mathematics and Computer Science, USP S\~ao Carlos}{S\~ao Carlos, Brasil}
      {Guest Lecture: ``Problem Solving with Cooperative Mobile Agent Systems''}{April 26, 2023}
...
\pubListStart{28}
    ...
    {Jared Coleman, Dmitry Ivanov, Evangelos Kranakis, Danny Krizanc, and Oscar Morales-Ponce}
    {Journal of Computer and System Sciences, Volume 157, 103737}

    \pub
    {Comparing LLM-Based Translation Approaches for Extremely Low-Resource Languages}
    {Jared Coleman, Ruben Rosales, Kira Toal, Diego Cuadros, Nicholas Leeds, Bhaskar Krishnamachari, and Khalil Iskarous}
    {LoResMT @ EACL 2026 --- The 9th Workshop on Technologies for Machine Translation of Low Resource Languages}

    \pub
    {Studying the Effect of Schedule Preemption on Dynamic Task Graph Scheduling}
    {Mohammadali Khodabandehlou, Jared Coleman, and Bhaskar Krishnamachari}
    {To Appear at MILCOM 2025 WS-9 - Workshop On The Internet Of Things For Adversarial Environments}

    \pub
    {Adapting Classic Scheduling Heuristics for Online Execution under Uncertainty}
    {Jason Chamorro, Gabriel Twigg-Ho, Jared Coleman, Tainã Coleman, Bhaskar Krishnamachari, and Mohammadali Khodabandehlou}
    {To Appear at WORKS @ SC25 - The 20th Workshop on Workflows in Support of Large-Scale Science}
    ...
    {Alex Sotiropoulos, Sulyab Thottungal Valapu, Linus Lei, Jared Coleman, and Bhaskar Krishnamachari}
    ...
    {CCCG 2025 - The 37th Canadian Conference on Computational Geometry}

    \pub
    {Linear Search with Probabilistic Detection and Variable Speeds}
    {Jared Coleman, Oscar Morales-Ponce}
    {IWOCA 2025 - The 36th International Workshop on Combinatorial Algorithms}

    \pub
    {Extended Abstract: A Chatbot for Endangered Language Research}
    {Diego Cuadros, Jared Coleman, Ruben Rosales, Glenn Nelson}
    {AmericasNLP @ NAACL 2025 - 5th Workshop on NLP for Indigenous Languages of the Americas}
...
\section{Other Research Products}
    ...
    % \resumeSubheading
    % {Kubishi Scholar (\href{https://scholar.kubishi.com}{scholar.kubishi.com})}{}
    % {An AI-assisted conference intelligence platform}{2025 - present}
...
\pubListStart{1}
  ...
  \pendingpub
  {\href{https://www.cnn.com/2025/09/02/tech/ai-endangered-language-preservation}{This new tech could save old languages from dying out}}
  {Clare Duffy, CNN}
  {September 2, 2025}

  \pendingpub
  {\href{https://www.smithsonianmag.com/science-nature/can-ai-help-revitalize-indigenous-languages-180987060/}{Can A.I. Help Revitalize Indigenous Languages?}}
  {Serena Jampel, Smithsonian Magazine}
  {July 31, 2025}
